...
class WriterTest extends EqualTest {
    ...
    @Test
    void testWriterEmptyLoe() {
        try {
            Writer writer = new Writer("./data/testWriterEmptyLoe.json");
            writer.open();
    ...
    void testWriterGeneralLoe() {
        try {
            ...
            Writer writer = new Writer("./data/testWriterGeneralLoe.json");
            writer.open();
            writer.writeSave(listOfEntries);
            writer.close();
